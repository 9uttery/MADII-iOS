    ...
    var body: some View {
        ZStack {
            Color.black.opacity(0.8).ignoresSafeArea()
                .onTapGesture { withoutAnimation { showReportPopUp = false } }

            PopUp(title: "신고 이유를 알려주세요", leftButtonTitle: "취소", leftButtonAction: { showReportPopUp = false }, rightButtonTitle: "확인", rightButtonColor: selectedOption.isEmpty ? .gray : .white, rightButtonAction: report) {
